...
public class AFCItems
{
    ...
    public static final Map<AFCWood, ItemId> LUMBER = Helpers.mapOf(AFCWood.class, wood -> register("wood/lumber/" + wood.name()));

    public static final Map<AFCWood, ItemId> SUPPORTS = Helpers.mapOf(AFCWood.class, wood ->
    ...
    public static final Map<AFCWood, ItemId> BOATS = Helpers.mapOf(AFCWood.class, wood -> register("wood/boat/" + wood.name(), () -> new TFCBoatItem(AFCEntities.BOATS.get(wood), new Item.Properties())));

    public static final Map<AFCWood, ItemId> CHEST_MINECARTS = Helpers.mapOf(AFCWood.class, wood -> register("wood/chest_minecart/" + wood.name(), () -> new TFCMinecartItem(new Item.Properties(), TFCEntities.CHEST_MINECART, () -> AFCBlocks.WOODS.get(wood).get(Wood.BlockType.CHEST).get().asItem())));

    public static final Map<AFCWood, ItemId> SIGNS = Helpers.mapOf(AFCWood.class, wood -> register("wood/sign/" + wood.name(), () -> new SignItem(new Item.Properties(), AFCBlocks.WOODS.get(wood).get(Wood.BlockType.SIGN).get(), AFCBlocks.WOODS.get(wood).get(Wood.BlockType.WALL_SIGN).get())));

    public static final Map<AFCWood, Map<Metal, ItemId>> HANGING_SIGNS = Helpers.mapOf(AFCWood.class, wood ->
    ...
    public static final Map<AFCFluidId, ItemId> FLUID_BUCKETS = AFCFluidId.mapOf(fluid ->
        register("bucket/" + fluid.name(), () -> new BucketItem(fluid.fluid().get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)))
    );

    //Normal items
    public static final ItemId RUBBER_BAR = register("rubber_bar");
    public static final ItemId MAPLE_SUGAR = register("maple_sugar");
    public static final ItemId BIRCH_SUGAR = register("birch_sugar");
