...
public class AFCBlocks
{
    ...
    public static final Map<AFCWood, Map<Metal, Id<TFCCeilingHangingSignBlock>>> CEILING_HANGING_SIGNS = registerHangingSigns("hanging_sign", TFCCeilingHangingSignBlock::new);
    public static final Map<AFCWood, Map<Metal, Id<TFCWallHangingSignBlock>>> WALL_HANGING_SIGNS = registerHangingSigns("wall_hanging_sign", TFCWallHangingSignBlock::new);

    public static final Map<AFCWood, Map<Wood.BlockType, Id<Block>>> WOODS = Helpers.mapOf(AFCWood.class, wood ->
    ...
    public static final Id<Block> TREE_TAP = register("tree_tap",
        () -> new TapBlock(
    ...
    {
        return new Id<>(RegistrationHelpers.registerBlock(AFCBlocks.FLUID_BLOCKS, AFCItems.ITEMS, name, blockSupplier, blockItemFactory));
    }
