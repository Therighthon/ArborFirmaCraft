...
AFC_WOODS: Dict[str, Wood] = {
    ...
    'teak': Wood(720, 1750, False, 'sparse'),
    'eucalyptus': Wood(720, 2100, False, 'sparse'),
    'baobab': Wood(707, 1000, False, 'bare'),
...
TREE_VARIANTS: Dict[str, Species] = {
    ...
    'acacia_koa': Species('acacia', False, 'sparse'),
    ...
    'scrub_hickory': Species('hickory', False, 'sparse'),
    'bigleaf_maple': Species('maple', False, 'sparse'),
    'weeping_maple': Species('maple', False, 'sparse'),
    ...
    'rainbow_eucalyptus': Species('eucalyptus', False, 'sparse'),
    'mountain_ash': Species('eucalyptus', False, 'sparse'),
    ...
    'small_leaf_mahogany': Species('mahogany', False, 'leaves'),
    ...
    'poplar': Species('aspen', False, 'sparse'),
    'iroko_teak': Species('teak', False, 'leaves'),
    'flame_of_the_forest': Species('teak', False, 'bare'),
    'lebombo_ironwood': Species('ironwood', False, 'leaves'),
