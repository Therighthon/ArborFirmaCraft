...
def generate(rm: ResourceManager):
    ...
    configured_placed_feature(rm, ('tree', 'coast_spruce'), 'tfc:random_tree', random_config('coast_spruce', 9, 1, place=tree_placement_config(1, 4, True)))
    ...
    configured_placed_feature(rm, ('tree', 'baobab'), 'tfc:random_tree', random_config('baobab', 11, 1, place=tree_placement_config(2, 3, True)))
    ...
    configured_placed_feature(rm, ('tree', 'baobab_large'), 'tfc:random_tree', random_config('baobab', 7, 1, '_large', place=tree_placement_config(3, 4, True)))
    ...
    configured_placed_feature(rm, ('tree', 'tualang'), 'tfc:random_tree', random_config('tualang', 6, 1, place=tree_placement_config(1, 14, True)))
    ...
    configured_placed_feature(rm, ('tree', 'tualang_large'), 'tfc:random_tree', random_config('tualang', 6, 1, '_large', place=tree_placement_config(1, 21, True)))
