...
def generate(rm: ResourceManager):
    ...
    forest_config(rm, 90, 275, 16, 40, 'gum_arabic', 'acacia', False)
    ...
    forest_config(rm, 85, 285, 12, 22, 'mulga_blackwood', 'blackwood', False)
    forest_config(rm, 150, 340, -4, 12, 'chestnut', 'chestnut', True)
    forest_config(rm, 305, 500, -12, 4, 'douglas_fir', 'douglas_fir', True)
    ...
    forest_config(rm, 150, 330, 10, 22, 'black_oak', 'oak', False)
    ...
    forest_config(rm, 185, 320, -10, 4, 'red_pine_', 'pine', False)
    ...
    forest_config(rm, 410, 500, -10, 2, 'redcedar', 'cypress', False)
    ...
    configured_placed_feature(rm, ('tree', 'gum_arabic'), 'tfc:random_tree', random_config('gum_arabic', 35, 1, place=tree_placement_config(1, 2, False)))
    ...
    configured_placed_feature(rm, ('tree', 'mulga_blackwood'), 'tfc:random_tree', random_config('mulga_blackwood', 35, 1, place=tree_placement_config(1, 2, True)))
    configured_placed_feature(rm, ('tree', 'mulga_blackwood_dead'), 'tfc:random_tree', random_config('mulga_blackwood', 6, 1, '_dead', place=tree_placement_config(1, 2, True)))
    ...
    configured_placed_feature(rm, ('tree', 'kapok_large'), 'tfc:random_tree', random_config('kapok', 6, 1, '_large', place=tree_placement_config(1, 2, True)))
    ...
    configured_placed_feature(rm, ('tree', 'weeping_maple'), 'tfc:random_tree', random_config('weeping_maple', 7, 1, place=tree_placement_config(1, 2, False)))
    ...
    configured_placed_feature(rm, ('tree', 'weeping_maple_large'), 'tfc:random_tree', random_config('weeping_maple', 14, 1, '_large', place=tree_placement_config(1, 2, False)))
    ...
    configured_placed_feature(rm, ('tree', 'stone_pine'), 'tfc:random_tree', random_config('stone_pine', 19, 1, place=tree_placement_config(1, 2, False)))
    ...
    configured_placed_feature(rm, ('tree', 'red_pine'), 'tfc:random_tree', random_config('red_pine_', 12, 1, place=tree_placement_config(1, 2, False)))
    configured_placed_feature(rm, ('tree', 'red_pine_dead'), 'tfc:random_tree', random_config('red_pine_', 6, 1, '_dead', place=tree_placement_config(1, 2, False)))
    ...
    configured_placed_feature(rm, ('tree', 'giant_rosewood'), 'tfc:random_tree', random_config('giant_rosewood', 15, 1, place=tree_placement_config(1, 2, True)))
    ...
    configured_placed_feature(rm, ('tree', 'atlas_cedar'), 'tfc:random_tree', random_config('atlas_cedar', 17, 1, place=tree_placement_config(1, 2, False)))
    ...
    configured_placed_feature(rm, ('tree', 'rainbow_eucalptus'), 'tfc:random_tree', random_config('rainbow_eucalptus', 15, 1, place=tree_placement_config(1, 2, True)))
    configured_placed_feature(rm, ('tree', 'rainbow_eucalptus_dead'), 'tfc:random_tree', random_config('rainbow_eucalptus', 4, 1, '_dead', place=tree_placement_config(1, 2, True)))
    ...
    configured_placed_feature(rm, ('tree', 'baobab'), 'tfc:random_tree', random_config('baobab', 11, 1, place=tree_placement_config(1, 2, True)))
    configured_placed_feature(rm, ('tree', 'baobab_large'), 'tfc:random_tree', random_config('baobab', 7, 1, '_large', place=tree_placement_config(1, 2, True)))
...
def forest_config(rm: ResourceManager, min_rain: float, max_rain: float, min_temp: float, max_temp: float, tree: str, basic_wood: str, old_growth: bool, old_growth_chance: int = None, spoiler_chance: int = None):
    ...
    wood_prefix = 'tfc'
    if basic_wood == 'baobab' or basic_wood == 'eucalyptus' or basic_wood == 'rainbow_eucalyptus' or basic_wood == 'hevea' or basic_wood == 'mahogany' or basic_wood == 'tualang' or basic_wood == 'teak' or basic_wood == 'cypress' or basic_wood == 'fig':
        wood_prefix = 'afc'
