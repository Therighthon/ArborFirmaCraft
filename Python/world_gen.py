...
def generate(rm: ResourceManager):
    ...
    forest_config(rm, 305, 500, -4, 6, 'douglas_fir', 'douglas_fir', True)
    ...
    forest_config(rm, 405, 500, -6, 12, 'bigleaf_maple', 'maple', True)
    forest_config(rm, 240, 320, -2, 8, 'weeping_maple', 'maple', True)
    forest_config(rm, 390, 500, 12, 20, 'live_oak', 'oak', True)
    forest_config(rm, 150, 330, 10, 22, 'black_oak', 'black_oak', True)
    ...
    forest_config(rm, 320, 500, 4, 10, 'coast_redwood', 'sequoia', True)
    forest_config(rm, 320, 500, 4, 10, 'sequoia', 'sequoia', True)
    ...
    forest_config(rm, 410, 500, -10, 2, 'redcedar', 'redcedar', True)
    ...
    configured_placed_feature(rm, ('tree', 'ash_large'), 'tfc:random_tree', random_config('ash', 1, 2, '_large', place=tree_placement_config(2, 5)))
    ...
    configured_placed_feature(rm, ('tree', 'hickory_large'), 'tfc:random_tree', random_config('hickory', 1, 2, '_large', place=tree_placement_config(1, 9)))
    ...
    configured_placed_feature(rm, ('tree', 'maple_large'), 'tfc:random_tree', random_config('maple', 1, 2, '_large', place=tree_placement_config(2, 5)))
    ...
    configured_placed_feature(rm, ('tree', 'baobab'), 'tfc:random_tree', random_config('baobab', 7, 2, place=tree_placement_config(3, 12, True)))
    ...
    configured_placed_feature(rm, ('tree', 'baobab_large'), 'tfc:random_tree', random_config('baobab', 7, 3, '_large', place=tree_placement_config(5, 12, True)))
    ...
    configured_placed_feature(rm, ('tree', 'mahogany_large'), 'tfc:random_tree', random_config('mahogany', 9, 1, '_large', trunk=[4, 8, 2, 'ancient_mahogany'], place=tree_placement_config(1, 2, True)))
    ...
    configured_placed_feature(rm, ('tree', 'tualang_large'), 'tfc:random_tree', random_config('tualang', 6, 1, '_large', trunk=[19, 24, 1, 'ancient_tualang'], place=tree_placement_config(1, 21, True)))
