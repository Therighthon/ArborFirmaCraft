...
def generate(rm: ResourceManager):
    ...
    # Trees / Forests
    forest_config(rm, 90, 275, 16, 40, 'acacia', 'acacia', True, old_growth_chance=12)
    forest_config(rm, 90, 275, 16, 40, 'gum_arabic', 'gum_arabic', False)
    forest_config(rm, 350, 500, 24, 40, 'acacia_koa', 'acacia', False)
    # forest_config(rm, 600, 700, -20, -22, 'ash', 'ash', True)
    forest_config(rm, 60, 240, -2, 12, 'black_ash', 'ash', True)
    forest_config(rm, 80, 265, 14, 20, 'evergreen_ash', 'ash', True)
    # forest_config(rm, 600, 700, -20, -22, 'aspen', 'aspen', False)
    forest_config(rm, 350, 500, -18, 6, 'quaking_aspen', 'aspen', False)
    # forest_config(rm, 600, 700, -20, -22, 'birch', 'birch', False)
    forest_config(rm, 125, 310, -12, 8, 'paper_birch', 'birch', False)
    forest_config(rm, 35, 150, 16, 40, 'blackwood', 'blackwood', True)
    forest_config(rm, 85, 285, 14, 22, 'mpingo_blackwood', 'blackwood', False)
    forest_config(rm, 150, 340, -4, 12, 'chestnut', 'chestnut', True)
    forest_config(rm, 305, 500, -10, 6, 'douglas_fir', 'douglas_fir', True)
    forest_config(rm, 220, 345, -6, 0, 'mountain_fir', 'douglas_fir', True)
    forest_config(rm, 210, 500, -16, -2, 'balsam_fir', 'douglas_fir', True)
    forest_config(rm, 600, 700, -20, -22, 'bitternut_hickory', 'hickory', True)
    # forest_config(rm, 210, 400, 0, 12, 'hickory', 'hickory', True)
    forest_config(rm, 400, 475, 14, 20, 'scrub_hickory', 'hickory', True)
    forest_config(rm, 390, 500, 20, 40, 'kapok', 'kapok', True, old_growth_chance=8, spoiler_chance=120)
    forest_config(rm, 260, 360, -8, 10, 'sugar_maple', 'maple', True)
    # forest_config(rm, 600, 700, -20, -22, 'maple', 'maple', True)
    forest_config(rm, 405, 500, -6, 12, 'bigleaf_maple', 'maple', True, old_growth_chance=4, spoiler_chance=50)
    forest_config(rm, 240, 320, -2, 8, 'weeping_maple', 'maple', True)
    forest_config(rm, 390, 500, 16, 22, 'live_oak', 'oak', True, old_growth_chance=8, spoiler_chance=50)
    forest_config(rm, 150, 330, 10, 22, 'black_oak', 'black_oak', True, old_growth_chance=1, spoiler_chance=50)
    ...
    forest_config(rm, 245, 360, 16, 40, 'rosewood', 'rosewood', False)
    forest_config(rm, 340, 440, 18, 24, 'giant_rosewood', 'rosewood', False)
    forest_config(rm, 320, 500, 4, 10, 'coast_redwood', 'sequoia', True, old_growth_chance=3)
    forest_config(rm, 320, 500, 4, 10, 'sequoia', 'sequoia', True, old_growth_chance=3)
    ...
    forest_config(rm, 220, 360, -20, -14, 'black_spruce', 'spruce', True)
    forest_config(rm, 330, 480, -8, 14, 'sycamore', 'sycamore', True)
    forest_config(rm, 100, 220, -16, 4, 'white_cedar', 'white_cedar', True)
    forest_config(rm, 165, 500, 8, 14, 'atlas_cedar', 'white_cedar', False)
    forest_config(rm, 330, 500, -4, 14, 'corkscrew_willow', 'willow', True)
    # forest_config(rm, 600, 700, -20, -22, 'willow', 'willow', True)
    forest_config(rm, 355, 500, 14, 22, 'weeping_willow', 'willow', False)
    forest_config(rm, 300, 450, 20, 40, 'rainbow_eucalyptus', 'rainbow_eucalyptus', True, old_growth_chance=1)
    forest_config(rm, 170, 325, 10, 24, 'eucalyptus', 'eucalyptus', False)
    forest_config(rm, 390, 500, 12, 20, 'mountain_ash', 'eucalyptus', True, old_growth_chance=3)
    forest_config(rm, 30, 190, 16, 28, 'baobab', 'baobab', True, old_growth_chance=2, spoiler_chance=10)
    forest_config(rm, 390, 500, 24, 40, 'hevea', 'hevea', False)
    forest_config(rm, 300, 430, 20, 40, 'mahogany', 'mahogany', True)
    ...
    forest_config(rm, 290, 415, 6, 18, 'weeping_cypress', 'cypress', False)
    forest_config(rm, 410, 500, -8, 2, 'redcedar', 'redcedar', True)
    forest_config(rm, 360, 500, 4, 18, 'bald_cypress', 'cypress', True, old_growth_chance=2)
    forest_config(rm, 340, 500, 18, 40, 'fig', 'fig', False)
    forest_config(rm, 290, 400, 14, 24, 'rubber_fig', 'fig', False)
    forest_config(rm, 320, 500, 14, 20, 'small_leaf_mahogany', 'mahogany', False)
    forest_config(rm, 330, 500, 18, 26, 'sapele_mahogany', 'mahogany', True)
    forest_config(rm, 250, 350, 22, 40, 'red_silk_cotton', 'kapok', True)
    ...
    # configured_placed_feature(rm, ('tree', 'black_ash'), 'tfc:overlay_tree', overlay_config('ash', 3, 5, basic_wood='ash', place=tree_placement_config(1, 5)))
    configured_placed_feature(rm, ('tree', 'black_ash_large'), 'tfc:random_tree', random_config('black_ash', 1, 2, '_large', place=tree_placement_config(2, 5)))
    configured_placed_feature(rm, ('tree', 'black_ash_dead'), 'tfc:random_tree', random_config('black_ash', 6, 1, '_dead', place=tree_placement_config(1, 9, True)))

    configured_placed_feature(rm, ('tree', 'sugar_maple'), 'tfc:random_tree', random_config('sugar_maple', 23, 1, place=tree_placement_config(1, 5)))
    configured_placed_feature(rm, ('tree', 'sugar_maple_large'), 'tfc:random_tree', random_config('sugar_maple', 5, 1, '_large', place=tree_placement_config(2, 5)))
    configured_placed_feature(rm, ('tree', 'sugar_maple_dead'), 'tfc:random_tree', random_config('sugar_maple', 6, 1, '_dead', place=tree_placement_config(1, 9, True)))


    configured_placed_feature(rm, ('tree', 'quaking_aspen'), 'tfc:random_tree', random_config('quaking_aspen', 16, trunk=[3, 5, 1, 'aspen'], place=tree_placement_config(1, 5)))
    configured_placed_feature(rm, ('tree', 'quaking_aspen_dead'), 'tfc:random_tree', random_config('quaking_aspen', 6, 1, '_dead', place=tree_placement_config(1, 9, True)))
    configured_placed_feature(rm, ('tree', 'paper_birch'), 'tfc:random_tree', random_config('paper_birch', 16, trunk=[2, 3, 1, 'birch'], place=tree_placement_config(1, 5)))
    configured_placed_feature(rm, ('tree', 'paper_birch_dead'), 'tfc:random_tree', random_config('paper_birch', 6, 1, '_dead', place=tree_placement_config(1, 9, True)))
    ...
    configured_placed_feature(rm, ('tree', 'douglas_fir_large'), 'tfc:stacked_tree', stacked_config('douglas_fir', 8, 12, 2, [(2, 3, 3), (1, 1, 3), (1, 1, 3)], 2, '_large', basic_wood = 'ancient_douglas_fir', place=tree_placement_config(2, 7)))
    ...
    # configured_placed_feature(rm, ('tree', 'bitternut_hickory'), 'tfc:random_tree', random_config('hickory', 9, place=tree_placement_config(1, 5)))
    configured_placed_feature(rm, ('tree', 'bitternut_hickory_large'), 'tfc:random_tree', random_config('bitternut_hickory', 1, 2, '_large', place=tree_placement_config(1, 9)))
    configured_placed_feature(rm, ('tree', 'bitternut_hickory_dead'), 'tfc:random_tree', random_config('bitternut_hickory', 6, 1, '_dead', place=tree_placement_config(1, 9, True)))
    ...
    configured_placed_feature(rm, ('tree', 'sequoia'), 'tfc:random_tree', random_config('sequoia', 1, place=tree_placement_config(1, 3)))
    ...
    configured_placed_feature(rm, ('tree', 'sycamore_large'), 'tfc:random_tree', random_config('sycamore', 1, 2, '_large', place=tree_placement_config(2, 5, True)))
    ...
    configured_placed_feature(rm, ('tree', 'corkscrew_willow'), 'tfc:random_tree', random_config('corkscrew_willow', 7, place=tree_placement_config(1, 3, True)))
    configured_placed_feature(rm, ('tree', 'corkscrew_willow_large'), 'tfc:random_tree', random_config('corkscrew_willow', 14, 1, '_large', place=tree_placement_config(2, 3, True)))
    configured_placed_feature(rm, ('tree', 'corkscrew_willow_dead'), 'tfc:random_tree', random_config('corkscrew_willow', 3, 1, '_dead', place=tree_placement_config(2, 3, True)))
    ...
    configured_placed_feature(rm, ('tree', 'black_ash'), 'tfc:random_tree', random_config('black_ash', 14, 1, place=tree_placement_config(1, 2, True)))
    ...
    configured_placed_feature(rm, ('tree', 'chestnut_large'), 'tfc:random_tree', random_config('chestnut', 5, 2, '_large', place=tree_placement_config(1, 2, True)))
    ...
    configured_placed_feature(rm, ('tree', 'bitternut_hickory'), 'tfc:random_tree', random_config('bitternut_hickory', 14, 1, place=tree_placement_config(1, 2, True)))
    ...
    configured_placed_feature(rm, ('tree', 'red_silk_cotton_large'), 'tfc:random_tree', random_config('red_silk_cotton', 6, 2, '_large', trunk=[15, 21, 2, 'ancient_kapok'], place=tree_placement_config(2, 15, True)))
    ...
    configured_placed_feature(rm, ('tree', 'bigleaf_maple_large'), 'tfc:random_tree', random_config('bigleaf_maple', 1, 2, '_large', trunk=[1, 4, 2, 'ancient_maple'], place=tree_placement_config(1, 2, True)))
    ...
    configured_placed_feature(rm, ('tree', 'mahogany_large'), 'tfc:random_tree', random_config('mahogany', 1, 1, '_large', trunk=[10, 14, 2, 'ancient_mahogany'], place=tree_placement_config(1, 2, True)))
